            ...
            <div class="panel ">
                <div class="panel-body">
                    ...
                    <div class="panel mt-4 mb-4">
                        <div class="panel-body">
                            <h4>@lang('Email')</h4>
                            <form method="POST" action="{{ route('users.update_email', $token) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <a class="btn btn-black btn-sm col-md-1" href="{{ route('users.settings', $user->id) }}">No</a>
