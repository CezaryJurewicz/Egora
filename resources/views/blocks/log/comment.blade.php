                        ...
                        <div class="pb-2">
                            <div class="row">
                                ...
                                <div class="col-3 text-right">
                                    ...
                                    @elseif (!is_null($row->comment->commentable) && !is_null($row->comment->commentable->commentable) && $row->comment->is_response())
                                    ...
                                    <a class="btn btn-primary btn-sm" href="{{ route('ideas.view', [$row->comment->commentable, 'comments' => 1, 'comment_notification_id'=> $row->id]).'#comment-'.$row->comment->id }}">{{ __('Open') }}</a>                                    
                                    @endif
                                </div>
                            </div>
                        </div>
