                ...
                <div class="card" style="border-bottom: 1px solid rgba(0, 0, 0, 0.125); border-radius: calc(0.25rem - 1px);">
                  ...
                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body col-md-10 offset-1">
                        ...
                        <p>I want to give you a brief description of how everything works:</p>
                        <ol class="bold">
                        ...
                        <u>yourself</u> – there is no higher goal for any philosopher than to “Know
                        Thyself”.</li>
                        ...
                        how popularly (IPI) various ideas are supported in the Egora among
                        its users. This knowledge gives us––the people––tremendous power
                        ...
                        to deliberate alternatives, and to organize politically as the
                        ...
                        government offices, as the nominees of the ILP.</li>
                        <li>Lastly, Egora is not a business; it is a <i>Republic</i>. The ILP
                        Members own it, and the ILP Members control it. Thus, all of the
                        surplus revenue that Egora generates is distributed to ILP Members,
                        based on how much they attend ILP meetings. The ILP Members
                        then decide which ILP candidates to support with their earned
                        credits.</li>
                        </ol>
                        ...
                        that’s leading the ILP, participating in ILP meetings, sharing Egora
                        with your friends, or just having fun with ideas. With you, we are
                        unstoppable!</p>
