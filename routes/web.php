...
Route::middleware(['verified', 'auth:admin,web'])->group(function() {
    ...
    Route::prefix('/updates')->name('updates.')->group(function(){
        ...
        Route::get('/{update}/redirect', 'UpdateController@redirect')->name('redirect')->middleware('can:redirect,update');
    ...
    Route::prefix('/philosophers')->name('users.')->group(function(){
        ...
        Route::put('/{comment}/status/update', 'UserController@status_update')->name('status.update')->middleware('can:comment,comment');
